...
def main():
    ...
    total_molar_mass = compute_molar_mass(parsed_formula, periodic_table)
    print(f"The total molar mass of the sample is: {total_molar_mass} g/mol")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    print(f"The total molar mass is: {total_molar_mass}")
